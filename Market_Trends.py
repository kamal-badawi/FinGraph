def run_market_trends(language_index, app_title):
    ...
    candle_scope_asset_type = st.sidebar.selectbox(label='Asset-Typ:',
    ...
    with candle_scope_date_from_col:
        candle_scope_date_from = st.date_input(label='Von-Datum:',
    ...
    with candle_scope_date_to_col:
        candle_scope_date_to = st.date_input(label='Bis-Datum:',
                                             value=today,
    ...
    candle_scope_tech_indicators = st.sidebar.multiselect(label="Technische Indikatoren:",
