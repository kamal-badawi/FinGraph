# Wichtiger Hinweis:
# Die Optimierungsmethoden und die Berechnung des Marktkapitals wurden mithilfe von ChatGpt erstellt
def run_Portfolio_Performance_Optimization(language_index,app_title):
    ...
    # Page Title
    Centred_Title.run_centred_title(app_title+' ('+selected_optimization_method+')')
