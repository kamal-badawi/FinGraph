# Wichtiger Hinweis:
# translations_main wurde durch ChatGpt generiert
...
with logo_column:
    ...
    st.markdown(
        '<div style="text-align: left;"><img src="https://i.postimg.cc/28qL0G2D/Fin-Graph-Logo.png" class="logo" width="100"></div>',
        unsafe_allow_html=True
    )
